            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('kategori.update', $kategori->KategoriID) }}">
                        ...
                        <div class="row mb-3">
                            <label for="KategoriID" class="col-md-4 col-form-label text-md-end">{{ __('Kategori ID') }}</label>
                            <div class="col-md-6">
                                <input id="KategoriID" type="text" value="{{ $kategori->KategoriID }}" 
                                class="form-control @error('KategoriID') is-invalid @enderror" 
